...
[ONELINER]
Shawn's Insight: 아래 세 가지를 순서대로 한 문장씩 작성. 절대 줄바꿈 하지 말 것.
문장1: 지금 ${label} 시장의 핵심 상황을 한 문장으로. (숫자 포함)
문장2: 가장 큰 리스크 또는 변수를 한 문장으로.
문장3: 지금 당장 눈여겨봐야 할 것을 한 문장으로. ~해야 한다 또는 ~주목할 필요가 있다로 끝낼 것.
[/ONELINER]
